...
console.log(createMenuItem("Cherry Pie", 6, "Desert"));

console.log(createMenuItem("Vodka Redbull", 3, "Alcoholic Beverage"));

console.log(createMenuItem("Chicken Noodle", 4, "Soups"));
...
const burger = {
  ...
  discount(person) {
    if (person === "teacher" || person === "student") {
      discount = this.price * 0.25 + 9;
    } else if (person === "public") {
      discount = this.price * 0.1 + 14.4;
    }
    return discount;
  },
};
...
reviews.push({
  name: "Teresa",
  rating: 5,
  feedback: "Loved the food really good service!",
});
